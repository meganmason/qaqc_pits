...
if __name__ == "__main__": #(everything outside of this tabbing can carry over)
    ...
    # path_in = '../timeseries_pitbook_sheets_EDIT/FOR_EDIT/**/**/*.xlsx'
    path_in = '/Users/meganmason491/Google Drive/SnowEx-2020-timeseries-pits/timeseries_pitbook_sheets_EDIT/**/**/**/*.xlsx'
    ...
    for i, filename in enumerate(glob.glob(path_in)):

        # filename
        print(i, 'F:', os.path.basename(filename))
